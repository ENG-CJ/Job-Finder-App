...
mixin NoDataErrorMixin{
  Center noDataError(BuildContext context, void Function(BuildContext context,dynamic result)? callback) {
    return Center(
        child: Padding(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        CText(text: "No Data Found Based On Your Query",
                          decorations: TextDecorations(
                              color: colors['error-color'] as Color,
                              family: "Poppins SemiBold"
                          ),),
                        SizedBox(height: 6,),
                        CText(text: "Try Again, And Search Predfined Job",
                          decorations: TextDecorations(
