          ...
          child: Column(
            ...
            children: [
              ...
              RadioListTileButton<USER_PROFILE>(
                  ...
                  checkBoxColor: hasTrueState(USER_PROFILE.company)
                      ? MaterialStatePropertyAll<Color>(Colors.white)
                      : null,
                  radioLabel: "Company Profile",
                  value: USER_PROFILE.company,
                  groupValue: user_profile!,
              ...
              RadioListTileButton<USER_PROFILE>(
                  ...
                  selectedTileBackgroundColor: colors['primary'] as Color,
                  selectedTileTextColor: Colors.white,
                  checkBoxColor: hasTrueState(USER_PROFILE.applicant)
                      ? MaterialStatePropertyAll<Color>(Colors.white)
                      : null,
                  radioLabel: "User Profile",
                  value: USER_PROFILE.applicant,
                  groupValue: user_profile!,
                  onChangedValue: (value) {
                    if (value != null) {
                      setState(() {
              ...
              Padding(
                ...
                child: Row(children: [
                  CText(text: "I've Already Registered? "),
                  TextButton(
                      onPressed: () {
